...
execute_process(
  COMMAND "C:/VSCod/Git/cmd/git.exe" --git-dir=.git show-ref "2.6.1"
  WORKING_DIRECTORY "C:/VSCod/PNG-image-of-the-IEC-61499-function-block/build/_deps/sfml-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/VSCod/PNG-image-of-the-IEC-61499-function-block/build/_deps/sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/VSCod/PNG-image-of-the-IEC-61499-function-block/build/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
